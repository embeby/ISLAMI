...
class MyTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
      ...
      textTheme: const TextTheme(
        ...
        titleLarge: TextStyle(
          fontSize: 20,color: Colors.white,fontWeight: FontWeight.w400,fontFamily: FontsManager.elMessiri
        ),
        headlineLarge: TextStyle(
          fontSize: 20,color: Colors.black,fontWeight: FontWeight.w700,fontFamily: FontsManager.elMessiri
        ),
  ...
  static final ThemeData darkTheme = ThemeData(
      ...
      textTheme: const TextTheme(
          headlineLarge: TextStyle(
              fontSize: 20,color: Colors.white,fontWeight: FontWeight.w700,fontFamily: FontsManager.elMessiri),
          labelLarge:  TextStyle(fontSize: 18,color:ColorsManager.yellowColor),
          titleSmall: TextStyle(
            fontSize: 25,
            color: Colors.white,
            fontWeight: FontWeight.w400,
